    ...
    public int updateUser(User user,int id){
        ...
        try {
            ...
            try {
                ...
                log.error("Error closing the common related objects created while updating the user. "+e);
            }
        }
        return exec;
    }
    ...
    public void updateUserGroups(int userId, String[] groups){
        ...
        try {
            ...
            try {
                ...
                log.error("Error closing the common related objects created while updating the user_groups. "+e);
            }
        }
    }
}

...
public class Update extends HttpServlet{
    ...
    public int updateUser(User user,int id){
        ...
        try {
            ...
            String query="UPDATE user_cred SET FirstName=\'"+user.getFirstName()+"\',LastName=\'"+user.getLastName()+"\',Country=\'"+user.getCountry()+"\',DOB=\'"+user.getDob()+"\',Email=\'"+user.getEmail()+"\',ContactNo=\'"+user.getContactNo()+"\' WHERE ID="+id+";";

        ...
        <div id="translate">
            <ul class="nav nav-pills">
                ...
                <c:forEach items="${permissionList}" var="permissions">
                    <c:choose>
                        <c:when test="${permissions eq translatePermission}">
                            <li id="translateTab" class="active">
                ...
                <li class="dropdown">
                    ...
                    <a id="userManagement" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span>
                        User
                        Management
                    ...
                    <ul class="dropdown-menu">
                        <c:forEach items="${permissionList}" var="permissions">
                            <c:choose>
                                <c:when test="${permissions eq userAddPermission}">
                                    <li id="addUserDrp"><a data-toggle="tab" href="#addUser"><span
